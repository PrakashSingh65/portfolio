export default function ServicesPage() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center w-full pt-32 transition-colors duration-300">
      <section className="w-full py-12 px-6 max-w-6xl mx-auto flex-1 flex flex-col justify-center overflow-hidden">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {services.map((service, index) => (
            <div data-aos="flip-up" data-aos-delay={index * 150} key={index} className="p-8 rounded-2xl bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 hover:border-emerald-500/50 dark:hover:border-emerald-400/30 transition-all group shadow-sm dark:shadow-none hover:shadow-md dark:hover:shadow-none">
