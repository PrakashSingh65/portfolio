            ...
            <div data-aos="fade-left" data-aos-delay="400">
              ...
              <div className="flex flex-wrap gap-2">
                {skills.map((skill, index) => (
                  <span data-aos="zoom-in" data-aos-delay={400 + (index * 50)} key={skill} className="px-4 py-2 bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-xl text-sm font-medium text-slate-700 dark:text-white/80 hover:bg-emerald-50 dark:hover:bg-emerald-400/10 hover:text-emerald-600 dark:hover:text-emerald-400 hover:border-emerald-200 dark:hover:border-emerald-400/30 transition-all cursor-default shadow-sm dark:shadow-none">
                    {skill}
                  </span>
                ))}
              </div>
