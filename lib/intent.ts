...
export async function detectIntent(query: string): Promise<IntentType> {
  ...
  if (
    ...
    cleanQuery.includes("who is Prakash") ||
...
- "intro": If the user is asking about identity, who the person is (Prakash Singh), name, role, biography, introduction, or general overview.
